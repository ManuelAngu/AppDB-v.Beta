...
public class Bayasrojas_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bayasrojas);
        ...
        if (extras != null) {
            ...
            if (cursor.moveToFirst()) {
                ...
                textView22.setText(nombre);
                textView23.setText(propiedades);
            } else {
