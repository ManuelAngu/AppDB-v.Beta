...
public class Estramonio_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_estramonio);
        ...
        if (extras != null) {
            ...
            if (cursor.moveToFirst()) {
                ...
                textView20.setText(nombre);
                textView21.setText(propiedades);
            } else {
