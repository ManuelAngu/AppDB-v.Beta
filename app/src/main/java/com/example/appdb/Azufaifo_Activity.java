...
public class Azufaifo_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_azufaifo);
        ...
        if (extras != null) {
            ...
            if (cursor.moveToFirst()) {
                ...
                textView30.setText(nombre);
                textView31.setText(propiedades);
            } else {
