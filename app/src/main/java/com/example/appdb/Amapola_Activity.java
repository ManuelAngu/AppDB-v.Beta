...
public class Amapola_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_amapola);
        ...
        if (extras != null) {
            ...
            if (cursor.moveToFirst()) {
                ...
                textView32.setText(nombre);
                textView33.setText(propiedades);
            } else {
